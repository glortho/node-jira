...
(function() {
    ...
    this.getLastSprintForRapidView = function(rapidViewId, callback) {
        ...
        var options = {
          rejectUnauthorized: this.strictSSL,
          uri: this.makeUri('/sprintquery/' + rapidViewId, 'rest/greenhopper/', 'latest'),
          method: 'GET',
          json:true
        };
    ...
    this.getSprintIssues = function getSprintIssues(rapidViewId, sprintId, callback) {
      ...
      var options = {
        rejectUnauthorized: this.strictSSL,
        uri: this.makeUri('/rapid/charts/sprintreport?rapidViewId=' + rapidViewId + '&sprintId=' + sprintId, 'rest/greenhopper/', 'latest'),
        method: 'GET',
        json: true
      };
    ...
    this.addIssueToSprint = function(issueId, sprintId, callback) {
        ...
        var options = {
          rejectUnauthorized: this.strictSSL,
          uri: this.makeUri('/sprint/rank', 'rest/greenhopper/', 'latest'),
          method: 'PUT',
